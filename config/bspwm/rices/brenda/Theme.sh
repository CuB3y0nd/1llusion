...
BORDER_WIDTH="0" NORMAL_BC="#d3c6aa" FOCUSED_BC="#a7c080"
...
# Gtk theme vars
gtk_theme="Everforest-zk" gtk_icons="Gruvbox-Plus-Dark" gtk_cursor="Qogirr-Dark" geany_theme="z0mbi3-EverForest"
